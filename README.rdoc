...
Feels like babylonia, validates like rails
   ...
   I18n.available_locales #=> [:en, :de, :it] should be like this, otherwise assign
   
   babylonian_field = BabylonianFields.new grass: 'Hello'
  
   babylonian_field.valid? #=> false
   babylonian_field.errors[:grass] #=> ["Grass should be filled in DE and IT"]
   babylonian_field.errors[:grass_de] #=> ["should be filled"]
   babylonian_field.errors[:grass_it] #=> ["should be filled"]
   babylonian_field.grass = {de: 'DEUTSCH', it: 'I'}
   babylonian_field.valid? #=> false
   babylonian_field.errors[:grass] #=> ["should be between 2 an 1000 characters in IT"]
   babylonian_field.errors[:grass_it] #=> ["should be between 2 an 1000 characters"]
